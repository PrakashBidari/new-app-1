...
<body class="bg-gray-900" cz-shortcut-listen="true">
    ...
    <section class="blood-request-form" style="background-color: lightblue">
        <form action="{{ route('blood_request_create') }}">
            @csrf
            @method('GET')
            <div class="my-form">
                <h1 style="text-align: center;font-size:24px;font-weight:bold;">Blood Request Form</h1>
                <input type="text" name="name" placeholder="Full Name" required style="background-color: rgb(222, 247, 255)">
                <input type="email" name="email" placeholder="Email" required style="background-color: rgb(222, 247, 255)">
                <input type="text" name="address" placeholder="Address" required style="background-color: rgb(222, 247, 255)">
                <input type="text" name="phone" placeholder="Phone" required style="background-color: rgb(222, 247, 255)">
                <select id="my-select" name="blood_type" required style="background-color: rgb(222, 247, 255)">
                ...
                <textarea name="message" id="message" cols="30" rows="10" placeholder="Message" required style="background-color: rgb(222, 247, 255)"></textarea>
                <button type="submit" style="background-color: rgb(222, 247, 255)">Submit</button>
            </div>
        </form>
    </section>
